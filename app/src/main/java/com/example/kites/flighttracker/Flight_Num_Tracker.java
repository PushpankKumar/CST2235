...
public class Flight_Num_Tracker extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ListView list;
    String fn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_flight__num__tracker);
    ...
    private void fetch()
    {
        class myThread extends AsyncTask<String,Void,String>
        {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                dialog=ProgressDialog.show(Flight_Num_Tracker.this,null,"Please Wait...",false,true);
            }
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    String ib = URLEncoder.encode(fn, "UTF-8");
                    URL url=new URL(MyUrl.flight_url+ib);
    ...
    private void getJson(String s)
    {
        ...
        try
        {
            ...
            FlightAdapter adpt=new FlightAdapter(this,R.layout.flight_row,ll);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Flight ff=dd.fl;
        String fn=ff.c;
        Intent i1=new Intent(this,FlightDetail.class);
        i1.putExtra("h",h);
        i1.putExtra("i",i);
        i1.putExtra("v",v);
        i1.putExtra("la",la);
